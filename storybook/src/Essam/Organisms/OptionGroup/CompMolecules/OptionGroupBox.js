...
const OptionGroupBox = ({ removeGroup, index }) => {
  const [groupName, setGroupName] = useState("");
  const [inputChecked, setInputChecked] = useState(false);
  return (
    <div className="flex flex-col bg-grey-bg p-m mb-xs rounded-md">
      <div className="flex items-center justify-between mb-m">
        <input
          className={`font-normal text-sm text-dark placeholder-dark focus:outline-none bg-accent-shd7 w-12.7xl ${
